...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            ...
            <?php $sql = "SELECT distinct c.id as clinicid, c.shopname as clinicname, c.mobile as mobile, c.address as address, c.area as area FROM clinic c, doctor d where (c.id, d.id) IN (select clinicid, doctorid FROM venue) and area='$area' and specialization='$specialization'";
