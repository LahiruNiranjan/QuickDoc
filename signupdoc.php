...
if (isset($_POST['reg_user'])) {
	...
	if (count($errors) == 0) {
		...
		$stmt = $conn->prepare("INSERT INTO doctor (name,password,email,mobile, degree,specialization,regno,image) VALUES (?,?,?,?,?,?,?,?)");
		$stmt->bind_param("sssissss", $user, $pass, $email, $mobile, $degree, $specialization, $regno, $imagename);
