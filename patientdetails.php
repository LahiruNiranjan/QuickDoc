	 ...
	 <div class="ml-2 p-2 bg-white" style="margin-top:-80px;">
	  <div class="row">
		...
		<div class="col-sm-7 col-12">
				<h3 class="mt-0 d-none d-sm-block text-center mt-4 ml-2"><?php echo $clinicname;?></h3>
				<h5 class="mt-3 d-block d-sm-none text-center"><b><?php echo $clinicname;?></b></h5>
				<hr>
			<div class="desktop d-sm-block d-none text-left mt-2">
				<p><i class="fas fa-address-card"></i> <?php echo $address;?></p>
				<p><b>Working Hours:</b> <i class="fas fa-check-circle text-success"></i> <?php echo $openhours;?> Hrs</p>
			</div>
			<div class="desktop d-sm-none d-block text-left mt-2 small">
				<p><i class="fas fa-phone"></i> +94 9876543210</p>
				<p><i class="fas fa-address-card"></i> <?php echo $address;?></p>
				<p><b>Working Hours:</b> <i class="fas fa-check-circle text-success"></i> <?php echo $openhours;?> Hrs</p>
			</div>
			<hr>
