...
if ($result->num_rows > 0) {
  ...
  if (count($errors) == 0) {
     ...
     $stmt = $conn->prepare("INSERT INTO clinic (clinicname, mobile, regno, area, city, address, openhours, email, password, image
	 ) VALUES (?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssssssssss", $clinicname,$mobile, $regno, $area, $city, $address, $openhours,$email,$pass, $imagename);
      
    $clinicname = test_input($name);
          ...
          <div class="card-body">
            ...
            <?php include('errors.php'); ?>
              <div class="form-label-group">
                ...
                <label for="inputUserame">Enter Hospital Name</label>
              </div>
