									...
									<hr>
									  <thead>
										  <tr>
											  ...
											  <th><i class=" fa fa-edit"></i>Appointment Status</th>
										  </tr>
									  </thead>
										<tbody>
                          
										<?php $sql = "SELECT * FROM book where userid = $userid and date >= CURDATE() order by date desc";
										$result = $conn->query($sql);
										if ($result->num_rows > 0) {
											...
											$name= $rows['name'];
											$appointmentstatus= $rows['appointmentstatus'];
											$sql1 = "SELECT * FROM clinic where id ='$clinicid'";
											$result1 = $conn->query($sql1);
											if ($result1->num_rows > 0) {
												$row1 = $result1->fetch_assoc();
												$shopname = $row1['clinicname'];
											}
									   ...
									   <tr>
											...
											<td>
												...
												<?php }else if($appointmentstatus == 0){ ?>
