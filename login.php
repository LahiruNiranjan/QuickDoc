...
<html lang="en">
    ...
    <body background="image/medical-5459654_1280.png" id="page-top">
        <!-- Navigation-->
						  ...
						  <div class="text-center">
							...
							<div class="row">
								<div class="col-12 col-sm-4">
									<a class="d-block text-center mt-2 small text-success" href="signup.php">Sign up as Dispensary doctor</a>
								</div>
								<div class="col-12 col-sm-4">
									<a class="d-block text-center mt-2 small text-success" href="signupdoc.php">Sign up as <span class="form-check-label">Main Hospital Doctor</span></a>
								</div>
								<div class="col-12 col-sm-4">
								 <a class="d-block text-center mt-2 small text-success" href="signupclinic.php">Sign up as <span class="form-check-label">Main Hospital</span></a>
								</div>
							</div>
						  </form>
						  </div>
