			...
			<form method="POST" action="profile.php">
				<input type="hidden"  name="email" value="<?= $email ?>" >
					<div style="text-align:center;">
						<button  class="btn btn-primary btn-lg mt-sm-4 text-uppercase" name="profile" type="submit"><i class='fas fa-user-alt' style='font-size:30px;color:White'></i>&nbsp;&nbsp;&nbsp;View Profile</button>
					</div>
			</form>
            <div class="container" style="padding-top: 40px;">
                <div class="masthead-subheading">Make Things Easy Reffer A Patient !</div>
                <div class="masthead-heading text-uppercase">Stay Home, Stay Safe</div>
				
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#findshop">Book a Doctor For Patient</a>
        ...
        <section class="page-section" id="findshop">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Find Hospital to Book Doctor</h2>
                </div>
				<hr>
                <form method="get" action="browseclinics.php">
           		...
           		<div class="col-sm-2">
                    <div class="text-center">
                        <div id="success"></div>
                        <button class="btn btn-primary btn-lg mt-sm-4 text-uppercase" type="submit"><i class="fa fa-search" aria-hidden="true"></i>&nbsp; &nbsp;Find</button>
                    </div>
				</div>
                </form>
        </section>
